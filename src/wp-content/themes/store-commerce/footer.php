...
?>
		...
		<section class="footer-bottom">
			<div class="container">
                ...
                printf( esc_html__( 'Copyright &copy; %1$s %2$s. %6$s Proudly powered by %3$s | Theme: %5$s by %4$s.', 'store-commerce' ), esc_attr( date( 'Y' ) ), esc_html( get_bloginfo( 'name' ) ), '<a href="https://wordpress.org/" target="_blank">WordPress</a>', '<a href="https://athemeart.com/downloads/shopstore/" target="_blank">aThemeArt</a>', '<a href="https://athemeart.com/downloads/shopstore/" target="_blank" rel="nofollow">Store Commerce</a>','<br/>' );
                ?></p>
